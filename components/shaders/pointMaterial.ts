    ...
    super({
      ...
      fragmentShader: /* glsl */ `
        ...
        float sparkleNoise(vec3 seed, float time) {
          ...
          float sparkle = sin(slowTime + hash * 6.28318) * 0.5 + sin(slowTime * 1.7 + hash * 12.56636) * 0.3 + sin(slowTime * 0.8 + hash * 18.84954) * 0.2;
          ...
          return 0.7 + mix(normalizedSparkle, smoothCurve, normalizedSparkle * normalizedSparkle) * 1.3;
        }
        void main() {
      ...
      `,
      uniforms: { positions: { value: null }, initialPositions: { value: null }, uTime: { value: 0 }, uFocus: { value: 5.1 }, uBlur: { value: 30 }, uTransition: { value: 0.0 }, uPointSize: { value: 2.0 }, uOpacity: { value: 1.0 }, uRevealFactor: { value: 0.0 }, uRevealProgress: { value: 0.0 } },
      transparent: true,
      depthWrite: false,
    });
  }
